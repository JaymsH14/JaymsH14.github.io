# AGENTS.md — DigitalStone AI Agency Website

## Project Overview

This is the main business website for **DigitalStone AI Agency**. It is a fully static site (HTML, CSS, vanilla JavaScript only — no frameworks, no build tools) deployed via **GitHub Pages** to an existing repository. The goal is to faithfully implement the provided Codex design file into clean, production-ready static files.
...
These rules govern how Codex should translate the provided Codex design file into code.
...
1. Review this AGENTS.md fully before writing any code
2. Open the provided Codex design file and use it as the source of truth for all visual decisions
